...
To my FindMaxValue method implementation: I could simply use "return FindTopNValues(anyOldOrderValues, 1)[0]", but I decided to implement this it using Linq Max() method, because it's probably more efficient than OrderByDescending()+Take() methods I use in FindTopNValues.